...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    ...
    description:
      'Projet d\'études afin d\'expérimenter la technologie symfony sur le thème des châteaux. Projet individuel. Année de réalisation : 2022',
  ...
  },
  {
    ...
    description:
      'Collaboration avec l\'école de journalisme de Strasbourg. Le site est un CMS fait avec symfony où les étudiants de journalisme peuvent rentrer leurs articles à l\'aide d\'un back office. C\'est un projet collectif où je me suis occupé des lecteurs vidéos et des fonctionnalités de saisie de texte dans la partie back office tout en aidant un peu dans la partie Back end. Année de réalisation : 2022.',
    stack: ['Symfony', 'Tailwind CSS'],
  ...
  },
  {
    name: 'Snake Game',
    description:
      'TP en javascript qui m\'a permis de m\'entrainer à la programmation orienté objet en Javascript. Projet individuel. Année de réalisation : 2023.',
  ...
  },
  {
    ...
    description:
      'Projet en collaboration avec le parcours création numérique sur le thème de l\'eau. Projet collectif, je me suis occupé de l\'intégration front end des maquettes. Année de réalisation : 2022.',
